              ...
              <div className="p-2 grid grid-cols-3 gap-2">
                ...
                <div className="flex flex-col gap-1">
                  <div>
                    <a
                      href="/api"
                      className="flex items-center gap-2 px-2 py-1.5 text-sm hover:bg-gray-100 rounded-md transition-colors"
                    >
                ...
                <a
                  href="/webhooks"
                  className="block p-4 rounded-xl bg-gradient-to-br from-blue-100 via-blue-50 to-indigo-100 border border-blue-200/50 hover:from-blue-200 hover:via-blue-100 hover:to-indigo-200 transition-all duration-300 relative overflow-hidden group"
                >
                  ...
                  <div className="relative flex flex-col items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-gray-700 leading-relaxed">
                        Set up HTTP endpoints to receive email data
                      </div>
                    </div>
                  </div>
                </a>
                ...
                <a
                  href="/mail"
                  className="block p-4 rounded-xl bg-gradient-to-br from-green-100 via-emerald-50 to-teal-100 border border-green-200/50 hover:from-green-200 hover:via-emerald-100 hover:to-teal-200 transition-all duration-300 relative overflow-hidden group"
                >
                  ...
                  <div className="relative flex flex-col items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-gray-700 leading-relaxed">
                        Route emails to different endpoints based on rules
                      </div>
                    </div>
                  </div>
                </a>
