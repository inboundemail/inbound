...
async function getGitHubStars() {
  try {
    const response = await fetch(
      "https://api.github.com/repos/R44VC0RP/inbound",
      {
        ...
        <div className="flex items-center gap-2 min-w-0">
          <a href="/" className="flex items-center gap-2 min-w-0">
            <img
              ...
              width={32}
              height={32}
              className="inline-block align-bottom flex-shrink-0"
            />
            ...
            <DropdownMenuContent align="center" className="w-80 p-2">
              <DropdownMenuItem asChild className="p-0">
                <a
                  ...
                  className="w-full cursor-pointer p-4 rounded-lg hover:bg-blue-50 hover:border-blue-200 border border-transparent transition-all duration-200 group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-gray-500 mt-1 group-hover:text-blue-600">
                        Convert emails into HTTP POST requests to your endpoints
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <DropdownMenuItem asChild className="p-0">
                <a
                  ...
                  className="w-full cursor-pointer p-4 rounded-lg hover:bg-green-50 hover:border-green-200 border border-transparent transition-all duration-200 group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-gray-900 text-sm group-hover:text-green-900">
                        ImprovMX Alternative
                      </div>
                      <div className="text-xs text-gray-500 mt-1 group-hover:text-green-600">
                        Better email forwarding with more control and
                        reliability
                      </div>
                    </div>
                  </div>
              ...
              <DropdownMenuItem asChild className="p-0">
                <a
                  href="/addtoblocklist"
                  className="w-full cursor-pointer p-4 rounded-lg hover:bg-red-50 hover:border-red-200 border border-transparent transition-all duration-200 group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-medium text-gray-900 text-sm group-hover:text-red-900">
                        Add to Blocklist
                      </div>
                      <div className="text-xs text-gray-500 mt-1 group-hover:text-red-600">
                        Block unwanted senders with one-click protection
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <DropdownMenuItem asChild className="p-0">
                <a
                  ...
                  className="w-full cursor-pointer p-4 rounded-lg hover:bg-purple-50 hover:border-purple-200 border border-transparent transition-all duration-200 group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-gray-500 mt-1 group-hover:text-purple-600">
                        API references, guides, and integration examples
                      </div>
                    </div>
                  </div>
                </a>
