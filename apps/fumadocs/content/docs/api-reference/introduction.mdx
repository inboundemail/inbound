...
<Tip>
Learn about [rate limits](/docs/api-reference/rate-limits) to optimize your API usage and avoid hitting limits.
</Tip>
...
<CardGroup cols={2}>
  <Card title="Send Emails" icon="paper-plane" href="/docs/api-reference/emails/send-an-email">
  ...
  <Card title="Reply to Emails" icon="reply" href="/docs/api-reference/emails/reply-to-an-email">
    Send replies to received emails with full threading support
  </Card>
  
  <Card title="Manage Domains" icon="globe" href="/docs/api-reference/domains/create-new-domain">
...
<CardGroup cols={2}>
  <Card title="Authentication Guide" icon="key" href="/docs/api-reference/introduction#authentication">
    Complete guide to API authentication and security
  </Card>
  
  <Card title="Rate Limits" icon="clock" href="/docs/api-reference/rate-limits">
    Understand API limits and optimization strategies
  </Card>
  
  <Card title="Send Your First Email" icon="paper-plane" href="/docs/quickstart/getting-started#3-send-your-first-email">
    Start sending emails with the API
  </Card>
  
  <Card title="SDK Installation" icon="code" href="/docs/quickstart/getting-started#2-install-the-sdk">
