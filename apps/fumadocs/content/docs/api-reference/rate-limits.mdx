...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/docs/api-reference/introduction#authentication">
    Learn how to authenticate your API requests
  </Card>
  
  <Card title="Send Your First Email" icon="paper-plane" href="/docs/api-reference/emails/send-an-email">
