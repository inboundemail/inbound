This is how to generate the openapi spec for the v2 API using https://github.com/tazo90/next-openapi-gen

(You can pull that website and pull up to date documentation from there)

We are going to be using the typescript types for the definitions.
