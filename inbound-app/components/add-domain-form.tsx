            ...
            >
              ...
              {!showDomainSelection && !showBulkImport && currentStepIdx === 1 && (
                <div>
                  ...
                  {/* Zone File Download Section */}
                  {dnsRecords.length > 0 && (
                    <div className="flex items-center gap-2 mt-4">
                      <CheckList width="16" height="16" className="text-green-600" />
                      <h3 className="font-bold text-md text-foreground">Zone File Export</h3>
                    </div>
                  )}
                  ...
                  <div className="flex gap-3 mt-6">
                    ...
                    {!showDnsWarning && dnsRecords.some(record => record.type === 'MX') && (
                      <Button
                        ...
                        className="text-xs"
                      >
                        <CircleWarning2 width="14" height="14" className="mr-1" />
                        Show DNS Tips
                      </Button>
                    )}
                  </div>
