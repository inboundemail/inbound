...
export type BlockDocument = (BlogPosts | Newblog | SimplifyingEmailForDevelopers | _AgentStart) & { __isUnion?: true }
...
export interface BlockDocumentGenqlSelection{
    ...
    on_Newblog?: NewblogGenqlSelection
...
export interface NewblogGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface FragmentsMap {
  ...
  Newblog: {
    root: Newblog,
    selection: NewblogGenqlSelection,
}
  Query: {
    root: Query,
