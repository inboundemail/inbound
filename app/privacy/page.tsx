          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                EXON ENTERPRISE LLC ("we," "our," or "us") operates the Inbound
                email receiving service (the "Service"). This Privacy Policy
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700">
                ...
                <li>
                  To service providers who assist in our operations (AWS,
                  payment processors)
                </li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                our services and comply with legal obligations. Email data is
                typically retained for 30 days unless you configure different
                retention settings. You may request deletion of your data at any
                time.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg mt-4">
                <p className="text-gray-700">
                  ...
                  <br />
                  Email: privacy@inbound.exon.dev
                  <br />
